...
The `Guaraná Demo` project provides an evironment for testing and demonstration fo the `Guaraná` Presentation Engine. It encompasses all the components to simmulate a TV 3.0 receiver.
