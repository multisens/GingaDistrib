...
let services = [
  {
    ...
    serviceIcon: `<svg style="position: absolute; left: -40%; top: -50%; transform: scale(42%);">${CEFET.svgLogo}</svg>`,
  ...
  },
  {
    ...
    serviceName: "UFF TV",
    serviceIcon:
      '<svg style="position: absolute; left: -35%; top: -40%; transform: scale(66%);">' +
 ...
 style="position: absolute; transform: scale(30%); left: -120%; top: -45%;">
